...
pessoa(pedro, m, 21, jornalista, 70000, drama, rock, nao).
pessoa(camila, f, 34, engenheiro_civil, 70000, comedia, pop, sim).
pessoa(felipe, m, 51, fotografo, 70001, comedia, axe, sim).
...
casal(X,Y):-pessoa(X,A,B,C,D,E,F,G),pessoa(Y,L,M,N,D,P,Q,R).
